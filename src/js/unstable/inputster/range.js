const onInput = (parent, e) => {
    ...
    console.log(percentageMin, slide2);
    ...
    parent.querySelector('.range-slider__display .range-slider__display--start').setAttribute('data-low', slide1);
    parent.querySelector('.range-slider__display .range-slider__display--end').setAttribute('data-high', slide2);
}
